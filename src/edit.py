...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    self.root = root
    # Title of the window
    self.root.title("FreeProjectOS-EDIT")
    # Window Geometry
    ...
    # Initializing Status
    self.status.set("Welcome To Kernel-EDIT")
    # Creating Menubar
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","FreeProjectOS-EDIT is a simple text editor included with the FreeProject-OS")
